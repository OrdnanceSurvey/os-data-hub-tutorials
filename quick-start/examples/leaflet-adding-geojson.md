...
That's it! You can access the full version of the source code [here](https://labs.os.uk/public/os-api-resources/code-playground/quick-start/leaflet-adding-geojson).
