...
Once the GPX has been converted to a JavaScript object of GeoJSON data – it can be added as a layer to the map's style:
...
To achieve this, we can add some additional lines of code to the `'load'` event – before the `map.fitBounds();` method is called.
...
That's it! You can access the full version of the source code [here](https://labs.os.uk/public/os-api-resources/code-playground/quick-start/maplibre-gl-adding-gpx).
